...
class ProcessMonitor {
  constructor() {
    ...
    this.gameProcesses = {
      ...
      'Fivem': ['Fivem.exe'],
      'Resident Evil 1': ['bio.exe', 'ResidentEvil.exe'],
      'Resident Evil 2': ['re2.exe', 're2_remake.exe'],
      'Resident Evil 3': ['re3.exe', 're3_remake.exe'],
      'Resident Evil 4': ['re4.exe', 'bio4.exe'],
      ...
      'FC 22': ['FIFA22.exe'],
      'FIFA': ['FIFA.exe'],
      'PES': ['PES.exe', 'Settings.exe'],
      'Sekiro': ['sekiro.exe'],
      'Call of Duty 2': ['CoD2SP.exe', 'CoD2MP.exe'],
      'Battlefield 6': ['Battlefield6.exe', 'BF6.exe'],
      'Alan Wake 1': ['AlanWake.exe'],
      'Alan Wake 2': ['AlanWake2.exe'],
      'Sims 4': ['TS4.exe', 'TS4_x64.exe'],
      'Call of Duty Black Ops': ['BlackOps.exe', 't5sp.exe'],
      'Call of Duty Modern Warfare III': ['cod.exe', 'sp23.exe'],
      'Call of Duty Modern Warfare II': ['cod.exe', 'sp22.exe'],
      'Call of Duty Modern Warfare': ['ModernWarfare.exe', 'cod.exe'],
      'Call of Duty': ['CoD.exe', 'CoDMP.exe'],
      'Uncharted': ['u4.exe', 'tll.exe'],
      'Forza Horizon 5': ['ForzaHorizon5.exe'],
      'God of War': ['GoW.exe'],
      'Spirit of the Samurai': ['SpiritOfTheSamurai.exe'],
      'Ghost of Tsushima': ['GhostOfTsushima.exe'],
      'Silent Hill': ['SilentHill.exe', 'SH2.exe'],
      'WWE 2K25': ['WWE2K25.exe'],
      'Ready or Not': ['ReadyOrNot.exe', 'ReadyOrNot-Win64-Shipping.exe'],
      'The Witcher': ['witcher.exe'],
      'Assassins Creed': ['AssassinsCreed_Dx10.exe', 'AssassinsCreed_Dx9.exe'],
      'Mafia I': ['mafia.exe', 'Mafia20.exe'],
      'Mafia II': ['mafia2.exe'],
      'Far Cry 1': ['FarCry.exe'],
